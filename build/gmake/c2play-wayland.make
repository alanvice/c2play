...
ifeq ($(config),debug)
  OBJDIR     = obj/Debug/c2play-wayland
  TARGETDIR  = ../..
  TARGET     = $(TARGETDIR)/c2play-wayland
  DEFINES   += -DWAYLAND -DDEBUG
  INCLUDES  += -I../../src/Media -I../../src/UI -I../../src/UI/Wayland
  CPPFLAGS  += -MMD -MP $(DEFINES) $(INCLUDES)
  CFLAGS    += $(CPPFLAGS) $(ARCH) -g -std=c++11 -Wall -fpermissive
  CXXFLAGS  += $(CFLAGS) 
  LDFLAGS   += -lavformat -lavcodec -lavutil -lpthread -lasound -lrt -lEGL -lGLESv2 -lass -lwayland-client -lmali
  LIBS      += 
...
ifeq ($(config),release)
  OBJDIR     = obj/Release/c2play-wayland
  TARGETDIR  = ../..
  TARGET     = $(TARGETDIR)/c2play-wayland
  DEFINES   += -DWAYLAND -D
  INCLUDES  += -I../../src/Media -I../../src/UI -I../../src/UI/Wayland
  CPPFLAGS  += -MMD -MP $(DEFINES) $(INCLUDES)
  CFLAGS    += $(CPPFLAGS) $(ARCH) -O2 -std=c++11 -Wall -fpermissive
  CXXFLAGS  += $(CFLAGS) 
  LDFLAGS   += -s -lavformat -lavcodec -lavutil -lpthread -lasound -lrt -lEGL -lGLESv2 -lass -lwayland-client -lmali
  LIBS      += 
  RESFLAGS  += $(DEFINES) $(INCLUDES) 
  LDDEPS    += 
  LINKCMD    = $(CXX) -o $(TARGET) $(OBJECTS) $(LDFLAGS) $(RESOURCES) $(ARCH) $(LIBS)
...
$(OBJDIR)/Texture2D.o: ../../src/UI/Texture2D.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/WaylandWindow.o: ../../src/UI/Wayland/WaylandWindow.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
